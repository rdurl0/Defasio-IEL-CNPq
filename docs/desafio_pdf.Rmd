...
$$ \texttt{balance}_{i} \approx \beta_{0} + \beta_{1} \times \texttt{income} \left\{\begin{matrix}
\beta_2 \text{ se } \texttt{student}\\ 
0 \text{ se } \texttt{nonstudent}
\end{matrix}\right. $$
