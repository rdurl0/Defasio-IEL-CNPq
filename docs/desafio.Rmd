...
arquivo <- paste0(dir, "/Desafio-IEL-CNPq/data/Income1.csv")
...
```{r}
dir <- "C:/Users/rauld/OneDrive/Documentos/[documentos]Raul"
arquivo <- paste0(dir, "/Desafio-IEL-CNPq/data/Advertising.csv")
...
# SE(b0)
se_b0_hat <- sqrt( RSE^2 * ((1 / n) + (x_mean^2 / sum((X - x_mean)^2))))
